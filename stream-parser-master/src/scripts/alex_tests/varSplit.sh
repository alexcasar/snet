...
java -classpath /home/alexcasar/Desktop/snet/gits/stream-parser-master/src:/home/alexcasar/Desktop/snet/gits/stream-parser-master/src/jar_files/ojalgo-48.0.0.jar mstparser.RunParser 3 3 $calculateScores $exportScores "$vocabFilePath" "$scoresFilePath" "$corpusPath" "$corpusPath" "$parsesPath"
