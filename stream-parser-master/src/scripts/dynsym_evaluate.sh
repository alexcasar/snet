...
do
  ...
  exportScores=true;
  scoresFilePath="/home/alexcasar/Desktop/snet/gits/stream-parser-master/data/dynsym/scores/${winObserve}_1.fmi"; # Path to store/import scores
  ...
  do
    ...
    parsesPath="/home/alexcasar/Desktop/snet/gits/stream-parser-master/data/dynsym/parses/${currParses}";
    GSPathn="${GSPath}${winParse}_1.fmi"
