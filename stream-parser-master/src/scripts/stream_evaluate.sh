...
do
  ...
  exportScores=true;
  scoresFilePath="/home/alexcasar/Desktop/snet/gits/stream-parser-master/data/sample/scores/${winObserve}_1.fmi"; # Path to store/import scores
  ...
  do
    ...
    parsesPath="/home/alexcasar/Desktop/snet/gits/stream-parser-master/data/sample/parses/${currParses}";

    # Parse the corpus with current window sizes
    java -classpath /home/alexcasar/Desktop/snet/gits/stream-parser-master/src:/home/alexcasar/Desktop/snet/gits/stream-parser-master/src/jar_files/ojalgo-48.0.0.jar mstparser.RunParser "$winObserve" "$winParse" $calculateScores $exportScores "$vocabFilePath" "$scoresFilePath" "$observeCorpusPath" "$corpusPath" "$parsesPath"
